...
const CATEGORIES = {
  "QmFzZWJhbGwgUG9zaXRpb25z": ["Pitcher", "Catcher", "First base", "Second base", "Third base", "Shortstop", "Left field", "Center field", "Right field", "Designated hitter", "Relief pitcher", "Closer", "Starting pitcher", "Middle reliever", "Setup man", "Long reliever", "Left fielder", "Center fielder", "Right fielder", "First baseman", "Second baseman", "Third baseman", "Utility player", "Pinch hitter", "Pinch runner", "Backup catcher", "Bullpen catcher", "Ace", "Swing man", "Spot starter"],
  "RG9ncw==": ["Labrador Retriever", "German Shepherd", "Golden Retriever", "French Bulldog", "Bulldog", "Poodle", "Beagle", "Rottweiler", "Dachshund", "Boxer", "Siberian Husky", "Great Dane", "Doberman", "Shih Tzu", "Boston Terrier", "Pomeranian", "Corgi", "Australian Shepherd", "Cocker Spaniel", "Border Collie", "Chihuahua", "Pug", "Saint Bernard", "Mastiff", "Dalmatian", "Basset Hound", "Schnauzer", "Akita", "Bloodhound", "Newfoundland"],
  "U2VhdHRsZSBMYW5kbWFya3M=": ["Space Needle", "Pike Place Market", "Kerry Park", "Gas Works Park", "Museum of Pop Culture", "Fremont Troll", "Chihuly Garden and Glass", "Seattle Great Wheel", "Columbia Center", "Smith Tower", "Seattle Aquarium", "Woodland Park Zoo", "Discovery Park", "Alki Beach", "Ballard Locks", "International District", "Pioneer Square", "Capitol Hill", "University of Washington", "Safeco Field", "Climate Pledge Arena", "Lake Union", "Green Lake", "Volunteer Park", "Golden Gardens", "Seward Park", "Washington Park Arboretum", "Museum of Flight", "Seattle Central Library", "Waterfall Garden Park"],
  "Q29mZmVlIEJyZXdpbmcgTWV0aG9kcw==": ["Drip", "French press", "Espresso", "Pour over", "Cold brew", "Aeropress", "Moka pot", "Chemex", "Siphon", "Turkish", "Percolator", "Cowboy coffee", "Vietnamese phin", "Instant", "Keurig", "Vacuum pot", "Clever dripper", "Batch brew", "Nitro cold brew", "Soft brew", "Electric drip", "Manual drip", "Cafe solo", "Bodum press", "Kalita wave", "V60", "Woodneck", "Ibrik", "Cezve", "Eva solo"],
  "VHlwZXMgb2YgQ2hlZXNl": ["Cheddar", "Mozzarella", "Parmesan", "Brie", "Gouda", "Swiss", "Blue cheese", "Feta", "Provolone", "Camembert", "Manchego", "Gruyere", "Havarti", "Monterey Jack", "Colby", "Pepper jack", "Asiago", "Goat cheese", "Ricotta", "Mascarpone", "Gorgonzola", "Roquefort", "Stilton", "Pecorino", "Fontina", "Muenster", "Boursin", "Cotija", "Halloumi", "Paneer"],
  "T2NlYW5z": ["Pacific", "Atlantic", "Bay of Bengal", "Arctic", "Southern", "Bering Sea", "Caribbean Sea", "Mediterranean Sea", "Gulf of Mexico", "Baltic Sea", "North Sea", "Red Sea", "Black Sea", "Arabian Sea", "South China Sea", "Coral Sea", "Tasman Sea", "Philippine Sea", "Sea of Japan", "Barents Sea", "East China Sea", "Andaman Sea", "Yellow Sea", "Sargasso Sea", "Adriatic Sea", "Aegean Sea", "Norwegian Sea", "Greenland Sea", "Beaufort Sea", "Labrador Sea"],
  "QmFrZXJ5IEl0ZW1z": ["Croissant", "Baguette", "Sourdough", "Brioche", "Danish", "Eclair", "Cronut", "Tart", "Scone", "Profiterole", "Focaccia", "Ciabatta", "Challah", "Pretzel", "Donut", "Turnover", "Cinnamon roll", "Bear claw", "Palmier", "Cannoli", "Strudel", "Rugelach", "Kolache", "Babka", "Puff pastry", "Frangipane", "Linzer torte", "Paris brest", "Croquembouche", "Kouign amann"],
  "U3BvcnRzIFRlYW1z": ["Lakers", "Yankees", "Cowboys", "Patriots", "Warriors", "Red Sox", "Packers", "Steelers", "Celtics", "Dodgers", "Bulls", "Seahawks", "Maple Leafs", "Canadiens", "Arsenal", "Barcelona", "Real Madrid", "Manchester United", "Bayern Munich", "Juventus", "Cubs", "Giants", "Knicks", "Rangers", "Bruins", "Blackhawks", "76ers", "Heat", "Spurs", "Broncos"],
  "V2luZCBJbnN0cnVtZW50cw==": ["Flute", "Clarinet", "Oboe", "Bassoon", "Saxophone", "Trumpet", "Trombone", "French horn", "Tuba", "Piccolo", "Cornet", "Euphonium", "Baritone horn", "Alto sax", "Tenor sax", "Soprano sax", "Bass clarinet", "English horn", "Contrabassoon", "Flugelhorn", "Mellophone", "Sousaphone", "Alto flute", "Bass flute", "Recorder", "Tin whistle", "Ocarina", "Harmonica", "Panpipes", "Didgeridoo"],
  "Sm9iIFRpdGxlcw==": ["Manager", "Director", "Analyst", "Engineer", "Designer", "Consultant", "Coordinator", "Specialist", "Administrator", "Developer", "Accountant", "Assistant", "Supervisor", "Representative", "Technician", "Associate", "Officer", "Planner", "Researcher", "Architect", "Scientist", "Instructor", "Operator", "Producer", "Recruiter", "Strategist", "Auditor", "Controller", "Facilitator", "Paralegal"],
  "U3RyZWV0IFR5cGVz": ["Avenue", "Boulevard", "Lane", "Drive", "Court", "Place", "Street", "Road", "Way", "Circle", "Terrace", "Parkway", "Highway", "Freeway", "Alley", "Crescent", "Loop", "Trail", "Path", "Route", "Plaza", "Square", "Cove", "Ridge", "Point", "Vista", "Grove", "Row", "Walk", "Mews"],
  "Q2FyZCBHYW1lcw==": ["Poker", "Bridge", "Rummy", "Hearts", "Spades", "Blackjack", "Solitaire", "Gin rummy", "Euchre", "Cribbage", "Canasta", "Pinochle", "War", "Go fish", "Crazy eights", "Old maid", "Uno", "Phase 10", "Skip bo", "Rook", "Pitch", "Whist", "Baccarat", "Casino", "Kemps", "Bezique", "Piquet", "Sheepshead", "Tarot", "President"],
  "V2VhdGhlciBQaGVub21lbmE=": ["Rain", "Snow", "Sleet", "Hail", "Fog", "Mist", "Drizzle", "Thunderstorm", "Lightning", "Thunder", "Tornado", "Hurricane", "Blizzard", "Freezing rain", "Ice storm", "Dust storm", "Sandstorm", "Drought", "Heat wave", "Cold snap", "Nor'easter", "Derecho", "Squall", "Downburst", "Waterspout", "Microburst", "Graupel", "Virga", "Whiteout", "Haboob"],
  "VHlwZXMgb2YgUmVzdGF1cmFudHM=": ["Italian", "Mexican", "Chinese", "Japanese", "Thai", "Indian", "French", "Greek", "Vietnamese", "Korean", "Mediterranean", "Spanish", "American", "Brazilian", "Middle Eastern", "Ethiopian", "Cajun", "Barbecue", "Steakhouse", "Seafood", "Pizzeria", "Diner", "Bistro", "Tapas", "Sushi bar", "Ramen shop", "Pho house", "Dim sum", "Food truck", "Gastropub"],
  "T2ZmaWNlIFN1cHBsaWVz": ["Stapler", "Paper clips", "Binder clips", "Rubber bands", "Post it notes", "Highlighter", "Tape dispenser", "Scissors", "Hole punch", "Calculator", "Ruler", "Envelope", "File folder", "Notepad", "Whiteboard", "Marker", "Eraser", "Correction fluid", "Label maker", "Clipboard", "Push pins", "Staple remover", "Letter opener", "Desk organizer", "Pencil sharpener", "Sticky notes", "Index cards", "Paperweight", "Stamp pad", "Tacks"],
  "VHlwZXMgb2YgQmVycmllcw==": ["Strawberry", "Blueberry", "Raspberry", "Blackberry", "Cranberry", "Gooseberry", "Elderberry", "Boysenberry", "Mulberry", "Huckleberry", "Currant", "Lingonberry", "Cloudberry", "Acai", "Goji", "Barberry", "Juniper berry", "Dewberry", "Loganberry", "Marionberry", "Salmonberry", "Tayberry", "Bearberry", "Hackberry", "Thimbleberry", "Wineberry", "Chokeberry", "Sea buckthorn", "Buffaloberry", "Serviceberry"],
  "VHlwZXMgb2YgTm9vZGxlcw==": ["Spaghetti", "Ramen", "Udon", "Rice noodles", "Fettuccine", "Linguine", "Penne", "Rigatoni", "Soba", "Lo mein", "Pad thai noodles", "Vermicelli", "Angel hair", "Egg noodles", "Chow mein", "Cellophane noodles", "Glass noodles", "Rice vermicelli", "Lasagna sheets", "Macaroni", "Farfalle", "Orzo", "Rotini", "Ziti", "Bucatini", "Pappardelle", "Hokkien", "Shirataki", "Kelp noodles", "Somen"],
  "TW91bnRhaW5z": ["Everest", "Kilimanjaro", "Denali", "Rainier", "Matterhorn", "Fuji", "Blanc", "Elbrus", "Aconcagua", "Hood", "Shasta", "Whitney", "Pike's Peak", "St. Helens", "Baker", "Adams", "Olympus", "McKinley", "Logan", "Washington", "Vesuvius", "Etna", "Popocatepetl", "Cotopaxi", "Chimborazo", "Ararat", "Sinai", "Kenya", "Kinabalu", "Erebus"],
  "VHlwZXMgb2YgQmVhbnM=": ["Black beans", "Kidney beans", "Pinto beans", "Navy beans", "Lima beans", "Chickpeas", "Lentils", "Black eyed peas", "Cannellini beans", "Great northern beans", "Fava beans", "Soybeans", "Adzuki beans", "Mung beans", "Split peas", "Garbanzo beans", "Cranberry beans", "Flageolet beans", "Borlotti beans", "Edamame", "Anasazi beans", "Tepary beans", "Calypso beans", "Marrow beans", "Runner beans", "Butter beans", "Red beans", "Pink beans", "Appaloosa beans", "Mayocoba beans"],
  "S2l0Y2hlbiBVdGVuc2lscw==": ["Spatula", "Whisk", "Ladle", "Tongs", "Peeler", "Grater", "Colander", "Strainer", "Slotted spoon", "Wooden spoon", "Measuring cups", "Measuring spoons", "Can opener", "Corkscrew", "Garlic press", "Potato masher", "Pizza cutter", "Rolling pin", "Pastry brush", "Basting brush", "Skimmer", "Spider strainer", "Citrus juicer", "Zester", "Mortar and pestle", "Meat tenderizer", "Kitchen shears", "Pastry cutter", "Dough scraper", "Bench knife"],
  "VHlwZXMgb2YgUm9ja3M=": ["Granite", "Marble", "Limestone", "Sandstone", "Basalt", "Slate", "Shale", "Quartzite", "Obsidian", "Pumice", "Gneiss", "Schist", "Dolomite", "Conglomerate", "Breccia", "Chalk", "Flint", "Soapstone", "Serpentine", "Travertine", "Tuff", "Rhyolite", "Andesite", "Gabbro", "Peridotite", "Pegmatite", "Coal", "Chert", "Mudstone", "Siltstone"],
  "VFYgR2VucmVz": ["Sitcom", "Drama", "Reality", "Talk show", "Game show", "News", "Documentary", "Soap opera", "Crime", "Medical drama", "Legal drama", "Comedy", "Anthology", "Miniseries", "Variety show", "Cooking show", "Competition", "Sports", "Police procedural", "Science fiction", "Fantasy", "Horror", "Western", "Spy thriller", "Period drama", "Teen drama", "Mockumentary", "Late night", "Panel show", "Sketch comedy"],
  "VHlwZXMgb2YgU2FsYWRz": ["Caesar", "Shopska", "Cobb", "Caprese", "Waldorf", "Nicoise", "Chef salad", "Pasta salad", "Potato salad", "Coleslaw", "Spinach salad", "Arugula salad", "Garden salad", "Antipasto", "Taco salad", "Asian sesame", "Wedge", "Fruit salad", "Egg salad", "Tuna salad", "Chicken salad", "Kale salad", "Quinoa salad", "Farro salad", "Panzanella", "Fattoush", "Tabbouleh", "Olivier salad", "Ambrosia", "Bean salad"],
  "VHlwZXMgb2YgQmljeWNsZXM=": ["Road bike", "Mountain bike", "Hybrid", "Cruiser", "BMX", "Gravel bike", "Touring bike", "Cyclocross", "Fixed gear", "Single speed", "Tandem", "Recumbent", "Electric bike", "Folding bike", "Fat bike", "Track bike", "Commuter bike", "City bike", "Cargo bike", "Penny farthing", "Triathlon bike", "Time trial bike", "Beach cruiser", "Dutch bike", "Downhill bike", "Enduro bike", "Jump bike", "Dirt jumper", "Trail bike", "Kids bike"],
  "VHlwZXMgb2YgSGF0cw==": ["Baseball cap", "Beanie", "Fedora", "Cowboy hat", "Beret", "Bucket hat", "Trucker hat", "Snapback", "Sun hat", "Panama hat", "Newsboy cap", "Bowler", "Top hat", "Sombrero", "Visor", "Boater", "Cloche", "Pork pie", "Trilby", "Flat cap", "Safari hat", "Fez", "Turban", "Ushanka", "Stetson", "Derby", "Straw hat", "Wide brim", "Fascinator", "Homburg"],
  "VHlwZXMgb2YgTWlsaw==": ["Whole milk", "Skim milk", "Two percent", "One percent", "Almond milk", "Soy milk", "Oat milk", "Coconut milk", "Cashew milk", "Rice milk", "Goat milk", "Buttermilk", "Evaporated milk", "Condensed milk", "Lactose free", "Chocolate milk", "Strawberry milk", "Hemp milk", "Macadamia milk", "Pea milk", "Flax milk", "Half and half", "Heavy cream", "Light cream", "Buffalo milk", "Sheep milk", "Camel milk", "Kefir", "Raw milk", "Ultra filtered"],
  "VHlwZXMgb2YgQ29va2llcw==": ["Chocolate chip", "Oatmeal raisin", "Peanut butter", "Sugar cookie", "Snickerdoodle", "Gingerbread", "Shortbread", "Biscotti", "Macaroon", "Macaron", "Oreo", "Milano", "Digestive", "Gingersnap", "Pizzelle", "Madeline", "Linzer", "Thumbprint", "Russian tea cake", "Mexican wedding", "Pfeffernusse", "Spritz", "Almond cookie", "Fortune cookie", "Fig newton", "Nutter butter", "Animal crackers", "Graham cracker", "Wafer", "Ladyfinger"],
  "VHlwZXMgb2YgU291cA==": ["Chicken noodle", "Tomato", "Minestrone", "Clam chowder", "French onion", "Split pea", "Lentil", "Vegetable", "Beef stew", "Gazpacho", "Butternut squash", "Broccoli cheddar", "Potato leek", "Mushroom", "Wonton", "Miso", "Pho", "Udon soup", "Borscht", "Tortilla soup", "Corn chowder", "Lobster bisque", "Gumbo", "Posole", "Menudo", "Tom yum", "Hot and sour", "Egg drop", "Mulligatawny", "Avgolemono"],
  "UGFydHMgb2YgYSBCb29r": ["Cover", "Spine", "Pages", "Chapter", "Foreword", "Preface", "Introduction", "Table of contents", "Index", "Glossary", "Appendix", "Bibliography", "Epilogue", "Prologue", "Dedication", "Acknowledgments", "Title page", "Copyright page", "Dust jacket", "Endpapers", "Frontispiece", "Footnotes", "Margin", "Header", "Footer", "Binding", "Bookmark", "Blurb", "Colophon", "Verso"],
  "Rm9vdGJhbGwgUG9zaXRpb25z": ["Quarterback", "Running back", "Wide receiver", "Tight end", "Offensive tackle", "Offensive guard", "Center", "Defensive end", "Defensive tackle", "Linebacker", "Cornerback", "Safety", "Free safety", "Strong safety", "Fullback", "Halfback", "Slot receiver", "Nose tackle", "Outside linebacker", "Middle linebacker", "Nickelback", "Dimeback", "Kicker", "Punter", "Long snapper", "Holder", "Kick returner", "Punt returner", "Gunner", "Edge rusher"]
};

const CATEGORY_HINTS = {
  "QmFzZWJhbGwgUG9zaXRpb25z": ["Where players stand and what they do on a diamond.", "From the battery to the outfield grass."],
  "RG9ncw==": ["Breeds you might see at a dog park or pet store.", "From tiny lap companions to giant gentle friends."],
  "U2VhdHRsZSBMYW5kbWFya3M=": ["Places tourists and locals visit in the Emerald City.", "From the iconic tower to hidden neighborhood gems."],
  "Q29mZmVlIEJyZXdpbmcgTWV0aG9kcw==": ["Different ways to make your morning cup.", "From classic to modern contraptions and techniques."],
  "VHlwZXMgb2YgQ2hlZXNl": ["Dairy products you might find on a cheese board.", "From mild and creamy to sharp and crumbly."],
  "T2NlYW5z": ["Large bodies of salt water on Earth.", "Some are named for directions, regions, or what borders them."],
  "QmFrZXJ5IEl0ZW1z": ["Sweet and savory things you'd buy at a patisserie.", "From flaky French classics to filled pastries."],
  "U3BvcnRzIFRlYW1z": ["Professional franchises fans root for.", "From baseball to basketball to international football."],
  "V2luZCBJbnN0cnVtZW50cw==": ["Musical instruments you blow into.", "From orchestra sections to marching band staples."],
  "Sm9iIFRpdGxlcw==": ["Words that describe someone's role at work.", "Common suffixes for corporate and professional positions."],
  "U3RyZWV0IFR5cGVz": ["Suffixes you see in addresses and on street signs.", "From broad thoroughfares to narrow passages."],
  "Q2FyZCBHYW1lcw==": ["Games played with a standard deck or special cards.", "From casino classics to family game night favorites."],
  "V2VhdGhlciBQaGVub21lbmE=": ["Atmospheric conditions you might experience or forecast.", "From gentle precipitation to extreme events."],
  "VHlwZXMgb2YgUmVzdGF1cmFudHM=": ["Categories of cuisine or dining establishments.", "From ethnic food to specialty dining concepts."],
  "T2ZmaWNlIFN1cHBsaWVz": ["Items you'd find in a desk drawer or supply closet.", "For organizing, writing, and daily office tasks."],
  "VHlwZXMgb2YgQmVycmllcw==": ["Small fruits that grow on bushes or vines.", "From common grocery finds to foraged wild varieties."],
  "VHlwZXMgb2YgTm9vZGxlcw==": ["Pasta and noodle varieties from around the world.", "From Italian shapes to Asian wheat and rice varieties."],
  "TW91bnRhaW5z": ["Famous peaks and volcanoes around the world.", "From the Himalayas to the Cascades to active craters."],
  "VHlwZXMgb2YgQmVhbnM=": ["Legumes used in cooking across many cuisines.", "From pantry staples to heirloom varieties."],
  "S2l0Y2hlbiBVdGVuc2lscw==": ["Hand tools used for cooking and food prep.", "For stirring, measuring, cutting, and serving."],
  "VHlwZXMgb2YgUm9ja3M=": ["Geological materials and stone types.", "From igneous to sedimentary to metamorphic."],
  "VFYgR2VucmVz": ["Categories of television programming.", "From scripted to unscripted to specialized formats."],
  "VHlwZXMgb2YgU2FsYWRz": ["Named salads you might order at a restaurant.", "From classic combinations to international styles."],
  "VHlwZXMgb2YgQmljeWNsZXM=": ["Different styles of bikes for various purposes.", "From racing to commuting to off-road adventures."],
  "VHlwZXMgb2YgSGF0cw==": ["Headwear styles from around the world.", "From casual to formal to functional sun protection."],
  "VHlwZXMgb2YgTWlsaw==": ["Dairy and plant-based beverages.", "From cow's milk variations to alternative milks."],
  "VHlwZXMgb2YgQ29va2llcw==": ["Baked sweet treats in various styles.", "From homemade classics to store-bought favorites."],
  "VHlwZXMgb2YgU291cA==": ["Hot or cold liquid dishes served in a bowl.", "From comfort food classics to international specialties."],
  "UGFydHMgb2YgYSBCb29r": ["Components that make up a physical book.", "From the obvious exterior to organizational sections inside."],
  "Rm9vdGJhbGwgUG9zaXRpb25z": ["Where players line up on a football field.", "From offense to defense to special teams roles."]
};
